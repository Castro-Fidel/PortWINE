...
unset PW_TERM PW_EXEC_FROM_DESKTOP WEBKIT_DISABLE_DMABUF_RENDERER PW_VK_ICD_FILENAMES PW_USE_SETUP_FILE MANGOHUD_CONFIGFILE
unset LAUNCH_PARAMETERS PW_RUN_AFTER_EXE PW_RUN_AFTER_DELAY
