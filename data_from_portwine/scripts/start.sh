...
case "$PW_VULKAN_USE" in
    0) PW_DEFAULT_VULKAN_USE="$SORT_OPENGL!$SORT_VULKAN!$SORT_NEWEST!$SORT_STABLE!$SORT_LEGACY" ;;
    ...
    4) PW_DEFAULT_VULKAN_USE="$SORT_VULKAN!$SORT_OPENGL!$SORT_NEWEST!$SORT_STABLE!$SORT_LEGACY" ;;
